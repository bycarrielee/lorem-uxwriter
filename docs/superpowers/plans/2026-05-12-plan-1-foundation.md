...
**Goal:** Stand up a Next.js + Supabase project with working authentication (.gov.sg self-serve signup, admin invite), database schema, and route protection — ready for the agent service and UI to be built on top.
...
│   │   ├── (app)/
│   │   │   ├── editor/
│   │   │   │   └── page.tsx          ← placeholder, built in Plan 2
│   │   │   ├── library/
│   │   │   │   └── page.tsx          ← placeholder, built in Plan 4
│   │   │   ├── admin/
│   │   │   │   └── page.tsx          ← placeholder, built in Plan 3
...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-8">
      ...
      <p className="text-gray-500 text-sm mb-6">UX Writing Agent</p>
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-56 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-4 border-b border-gray-100">
          <span className="text-sm font-semibold text-gray-900">UX Writing Agent</span>
        </div>
...
export default function EditorPage() {
  return (
    <div className="p-8">
      ...
      <p className="text-gray-500 text-sm mt-1">Coming in Plan 2.</p>
    </div>
  )
}
```
...
export default function LibraryPage() {
  return (
    <div className="p-8">
      <h1 className="text-lg font-semibold text-gray-900">Copy library</h1>
      <p className="text-gray-500 text-sm mt-1">Coming in Plan 4.</p>
    </div>
  )
}
```
...
export default function AdminPage() {
  return (
    <div className="p-8">
      ...
      <p className="text-gray-500 text-sm mt-1">Coming in Plan 3.</p>
    </div>
  )
}
```
